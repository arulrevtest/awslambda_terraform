...
//  route_table_ids = ["${aws_route_table.arul_demo_private_west_1a_subnet_route_table.id}",
//    "${aws_route_table.arul_demo_private_west_1b_subnet_route_table.id}"]
//}
//
...
//  security_group_ids = ["${aws_security_group.arul_demo_lambda_vpc_security_group.id}"]
//  subnet_ids = ["${aws_subnet.arul_demo_private_west_1a.id}", "${aws_subnet.arul_demo_private_west_1b.id}"]
//}
